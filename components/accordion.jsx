			...
			<div className="accordion mx-auto max-w-[35rem]" id="accordionFAQ">
				{data?.map((item) => {
					...
					return (
						<div
							key={id}
							className="mb-5 overflow-hidden border rounded-lg accordion-item dark:border-jacarta-600 border-jacarta-100"
						>
							<h2
							...
							>
								...
								>
									...
									<svg
										...
										width="24"
										height="24"
										className="w-4 h-4 transition-transform accordion-arrow fill-jacarta-700 shrink-0 dark:fill-white"
									>

  ...
  return (
    <>
      ...
      <div className="relative px-6 pb-16 sm:px-0">
        ...
        <div className="absolute z-10 flex items-center justify-center w-12 h-12 p-3 -mt-6 text-xl bg-white rounded-full cursor-pointer swiper-button-prev-4 group top-1/2 left-4 text-jacarta-700 shadow-white-volume">
          <svg
        ...
        <div className="absolute z-10 flex items-center justify-center w-12 h-12 p-3 -mt-6 text-xl bg-white rounded-full cursor-pointer swiper-button-next-4 group top-1/2 right-4 text-jacarta-700 shadow-white-volume">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"

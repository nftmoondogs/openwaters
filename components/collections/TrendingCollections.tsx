      ...
      <section className="relative py-24 dark:bg-jacarta-800">
        ...
        <div className="">
          ...
          <div className="flex flex-col justify-center lg:flex-row gap-x-10">
              ...
              {collections.count > 0 ? (
                collections.collections
                  ...
                  .map((collection, index) => {
                    const { name, address, profileImage, totalSupply } =
                      collection;

                    return (
                      <Link href={`/collection/${address}`}>
                        <div className="flex flex-row items-center gap-6 border-b-[1px] border-jacarta-200 dark:border-white/10 py-4 px-2 md:px-6 text-base cursor-pointer hover:bg-jacarta-100 dark:hover:bg-jacarta-600">
                              ...
                              className={`${
                                calcPercent(
                                  ...
                                  : Number(
                                    ...
                                    Number(
                                      collections.volumes?.[index]?.volume_48
                                    )
                                  ? "text-[#22c55e]"
                                  : "text-[#ef4444]"
                              } `}
                          ...
                          <div className="w-[20%] flex flex-shrink-0 flex-col items-center gap-2 text-center text-xs md:w-[15%]">
            ...
            <div className="w-full lg:w-1/2">
              {collections.count > 0 ? (
                collections.collections.slice(10).map((collection, index) => {
                  const { name, address, profileImage, totalSupply } =
                    collection;

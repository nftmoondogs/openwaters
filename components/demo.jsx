	...
	return (
		<div>
			...
			<div className="modal lightbox fade show">
				<div className="w-full modal-dialog modal-dialog-centered modal-xl">
					<div className="bg-transparent border-0 modal-content">
						<div className="relative p-0 modal-body">
							<button
								type="button"
								className="top-0 p-3 btn-close position-absolute end-0"
